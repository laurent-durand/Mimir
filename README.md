...
> Local RAG assistant for indexing personal documents.

## Overview
This project is part of a "vibe-coding" marathon to build a diverse and high-performance portfolio. 
**Mimir** focuses on efficiency and leverages niche technologies to solve system-level challenges.

### Tech Stack
- **Languages**: Go
- **Concepts**: rag, ai, go, ollama
- **License**: Apache-2.0
